          ...
          <LinearGradient colors={['#1a365d', '#2b6cb0']} style={styles.headerGradient}>
            ...
            <View style={styles.profileHeader}>
              ...
              <View style={styles.departmentBadge}>
                ...
                <Text style={styles.departmentText}>{instructor.department}</Text>
              </View>
            </View>
          </LinearGradient>
          ...
          <View style={styles.content}>
            ...
            <View style={styles.infoCard}>
              ...
              <ProfileItem
                ...
                label="Date of Birth"
                value={formatDate(instructor.dob)}
                color="#5C6BC0"
              />
              <View style={styles.divider} />
                <ProfileItem
...
const styles = StyleSheet.create({
  ...
  userRole: { fontSize: 14, color: '#D1D5DB', marginTop: 4, fontWeight: '500' },
  departmentBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  departmentText: { color: '#FFF', fontSize: 13, fontWeight: '600' },
  content: { padding: 20 },
  sectionTitle: {
    fontSize: 15,
    fontWeight: '700',
