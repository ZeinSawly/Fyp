...
export default function FinanceLayout({ children, title = 'Dashboard' }) {
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Sider
        ...
        width={240}
        style={{
          background: 'linear-gradient(180deg, #1a365d 0%, #276749 100%)',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: '#94A3B8' }}>
                Antonine University — Finance Portal
              </div>
            </div>
          </div>
